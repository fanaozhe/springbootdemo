...
public class DateUtil {
    ...
    public static Date createYearTime(String dateTime) {
        return DateUtil.stringToDate(dateTime, DateUtil.FORMAT_YYYY_MM);
    }
 
    public static Date createDateMon(String dateTime) {
        return DateUtil.stringToDate(dateTime, DateUtil.FORMAT_DAY_SLASH);
    }
 
    public static Date createDateFormat(String dateTime) {
        return DateUtil.stringToDate(dateTime, DateUtil.FORMAT);
    }
 
    public static Date createDateMin(String dateTime) {
        return DateUtil.stringToDate(dateTime, DateUtil.FORMAT_DAY_HOUR_MIN);
    }
 
    public static Date createDateYearMon(String dateTime) {
        return DateUtil.stringToDate(dateTime, DateUtil.FORMAT_YYYYMM);
    }
 
    public static Date createDateYear(String dateTime) {
        return DateUtil.stringToDate(dateTime, DateUtil.FORMAT_YYYY);
    }
 
    public static Date createDateDay(String dateTime) {
        return DateUtil.stringToDate(dateTime, DateUtil.FORMAT_YYYYMMDD);
    }
    ...
    public static String getDateTimeYearMonStr(Date date) {
        return DateUtil.dateToString(date, DateUtil.FORMAT_YYYYMM);
    }
 
    public static String getDateTimeFormatStr(Date date) {
        return DateUtil.dateToString(date, DateUtil.FORMAT);
    }
 
    public static String getDateTimeMinStr(Date date) {
        return DateUtil.dateToString(date, DateUtil.FORMAT_DAY_HOUR_MIN);
    }
    ...
    public static String getDateYearTimeStr(Date date) {
        return DateUtil.dateToString(date, DateUtil.FORMAT_YYYY_MM);
    }
 
    public static String getDateMonStr(Date date) {
        return DateUtil.dateToString(date, DateUtil.FORMAT_DAY_SLASH);
    }
 
    public static String getDateYearStr(Date date) {
        return DateUtil.dateToString(date, DateUtil.FORMAT_YYYY);
    }
 
    public static String getDateDayStr(Date date) {
        return DateUtil.dateToString(date, DateUtil.FORMAT_YYYYMMDD);
    }
    ...
    //只显示月
    public static String getDateCNMMStr(Date date) { return DateUtil.dateToString(date, DateUtil.FORMAT_DAY_CN_MM); }
    ...
    public static String getDateEarly(Date date) {
        ...
        //计算第一天时间到传入时间的及那个天数
        c = DateUtil.getIntervalDays(beginDate, date);
